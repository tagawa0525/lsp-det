...
- 0.3.0（ADR 0013〜0016: `coverage` への改名、`didChangeWatchedFiles` の鮮度と先読み、下流側の代行 2 つ、欠けを名指しする宣言の形）も完了。ADR 0017 の英訳 3 つとドッグフーディング第 5 回も完了。次は外向きの提出（`docs/upstream-submissions.md` の順。文面を作ってユーザーの確認をもらってから出す）
