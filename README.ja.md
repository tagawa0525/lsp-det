...
| typescript-language-server   | `$/progress` "Initializing JS/TS language features…"                                                                                                                                                                                   | "[tsserver] Exited" のログ → `error`                                                                                             | TypeScript 5.9.3（`coverage` は各フォルダの根の設定 1 つが全ソースを含むときだけ。ADR 0023）            |
