...
| typescript-language-server  | `$/progress` "Initializing JS/TS language features…"                                                                                                                                                                                 | The "[tsserver] Exited" log → `error`                                                                                      | TypeScript 5.9.3 (`coverage` only where one config at each folder root takes in every source, ADR 0023)        |
