...
| ADR・`docs/research/`・`docs/v0.1-design.ja.md`・`docs/vision.ja.md` | 日本語                                          | 保守者の記録。必要になった ADR だけ個別に訳す                  |
| `scripts/*/README.md`・`dogfood/serena/README.ja.md`・`CLAUDE.md`    | 日本語                                          | 保守者の手順                                                   |
