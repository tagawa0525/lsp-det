...
| Dart analysis server        | `$/analyzerStatus` (`{isAnalyzing: boolean}`, marked deprecated) when the client does not declare `window.workDoneProgress`; otherwise `$/progress` with the token `ANALYZING` (title "Analyzing…")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `isAnalyzing: true` / begin → `readiness: "indexing"`; `isAnalyzing: false` / end → `"ready"` (the pair repeats on every analysis round, like rust-analyzer's `quiescent`). No health signal, so `unknown`                                                                                                                                                                                                                                                                                                                                                                                                                                               | `coverage: {scope: "workspace", incomplete: {}}` (expected; the vocabulary was measured with 3.13.0, the guarantees were not)                                                                                                                                                                                                                                        |
